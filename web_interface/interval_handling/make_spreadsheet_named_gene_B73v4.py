...
for gene in mygenes:
    ...
    for row in c:
        ...
        p_dict[myname].append("<a href='http://qteller.maizegdb.org/Rna_Protein_bar_chart_B73v4.php?name=%s&gene=Submit for mRNA Abundance!'>http://qteller.maizegdb.org/Rna_Protein_bar_chart_B73v4.php?name=%s&gene=Submit for mRNA Abundance!</a>" % (myname,myname))
        if args.link:
