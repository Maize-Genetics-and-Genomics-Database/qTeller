...
for gene in mygenes:
    ...
    for row in c:
        ...
        p_dict[myname].append("<a href='https://qteller.maizegdb.org/Rna_Protein_bar_chart_B73v5.php?name=%s&gene=Submit for mRNA Abundance!'>https://qteller.maizegdb.org/Rna_Protein_bar_chart_B73v5.php?name=%s&gene=Submit for mRNA Abundance!</a>" % (myname,myname))
        if args.link:
