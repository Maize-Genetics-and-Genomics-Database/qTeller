...
for gene in mygenes:
    ...
    for row in c:
        ...
        p_dict[myname].append("<a href='http://qteller.maizegdb.org/Rna_Protein_bar_chart_B73v5.php?name=%s&protein=Submit for Protein Abundance!'>https://qteller.maizegdb.org/Rna_Protein_bar_chart_B73v5.php?name=%s&protein=Submit for Protein Abundance!</a>" % (myname,myname))
        if args.link:
