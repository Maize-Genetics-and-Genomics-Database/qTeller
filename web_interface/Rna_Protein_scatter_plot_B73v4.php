...
exec("python image_handling/make_scatterplot_gene_B73v4.py --gene1 $mygene1 --gene2 $mygene2 --exps \"$all_info\" --xmax $xmax --ymax $ymax");
}else if((isset($_POST["gene"]) or isset($_GET["gene"])) && ($all_info == 'all')){
exec("python image_handling/make_scatterplot_gene_B73v4.py --gene1 $mygene1 --gene2 $mygene2 --xmax $xmax --ymax $ymax");
}else if((isset($_POST["protein"]) or isset($_GET["protein"])) && ($all_info == 'all')){
#echo $all_info;
exec("python image_handling/make_scatterplot_B73v4_Pro.py --gene1 $mygene1 --gene2 $mygene2 --xmax $xmax --ymax $ymax");
}else if((isset($_POST["protein"]) or isset($_GET["protein"])) && ($all_info != 'all')){
exec("python image_handling/make_scatterplot_B73v4_Pro.py --gene1 $mygene1 --gene2 $mygene2 --exps \"$all_info\" --xmax $xmax --ymax $ymax");
}
...
echo "See the expression or abundance of <a href=\"Rna_Protein_bar_chart_B73v4.php?name=$mygene1&info=$all_info&gene=$gene\">$mygene1</a> or <a href=\"Rna_Protein_bar_chart_B73v4.php?name=$mygene2&info=$all_info&gene=$gene\">$mygene2</a> as a bar chart<br>";
echo "<a href=\"Rna_Protein_scatter_plot_B73v4.php?name1=$mygene1&name2=$mygene2&xmax=$xmax&ymax=$ymax&info=$all_info&gene=$gene\">Regenerate this particular analysis</a> <-- copy this link to share this analysis.<br>";
...
echo "See the expression or abundance of <a href=\"Rna_Protein_bar_chart_B73v4.php?name=$mygene1&info=$all_info&protein=$protein\">$mygene1</a> or <a href=\"Rna_Protein_bar_chart_B73v4.php?name=$mygene2&info=$all_info&protein=$protein\">$mygene2</a> as a bar chart<br>";
echo "<a href=\"Rna_Protein_scatter_plot_B73v4.php?name1=$mygene1&name2=$mygene2&xmax=$xmax&ymax=$ymax&info=$all_info&protein=$protein\">Regenerate this particular analysis</a> <-- copy this link to share this analysis.<br>";
echo "<a href=\"http://genomevolution.org/CoGe/GEvo.pl?accn1=$mygene1;accn2=$mygene2;prog=blastn;show_cns=1;autogo=1;skip_feat_overlap=0\" target=\"_blank\">Compare these genes in GEvo</a><br>";
