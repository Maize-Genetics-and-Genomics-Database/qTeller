...
$mytissue1 = '"'.$mytissue.'"';
$mynames1 = '"'.$mynames.'"';
#echo "<p>tissue: $mytissue1</p>";
#echo "<p>names: $mynames1</p>";
echo exec("python image_handling/make_Multi_ProteinvsGene_chart_B73v4.py --names $mytissue1 --exps $mynames1");
...
echo "<a href=\"Mutli_ProteinvsGene_chart_B73v4.php?Tissues=$mytissue&gene_names=$mynames\">Regenerate this particular analysis</a> <-- copy this link to share this result.<br>";
?>
</div>
</body>
</html>