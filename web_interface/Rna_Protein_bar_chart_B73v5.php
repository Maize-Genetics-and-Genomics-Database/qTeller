...
echo exec("python image_handling/make_bar_chart_gene_B73v5.py --gene $mygene --exps \"$all_info\"");
}else if((isset($_POST["gene"]) or isset($_GET["gene"])) && ($all_info == 'all')){
echo exec("python image_handling/make_bar_chart_gene_B73v5.py --gene $mygene");
}else if((isset($_POST["protein"]) or isset($_GET["protein"])) && ($all_info == 'all')){
echo exec("python image_handling/make_bar_chart_B73v5_Pro.py --gene $mygene");
} else if((isset($_POST["protein"]) or isset($_GET["protein"])) && ($all_info != 'all')){
echo exec("python image_handling/make_bar_chart_B73v5_Pro.py --gene $mygene --exps \"$all_info\"");
}
#echo "<p>$mygene</p>";
#echo "<p>$all_info</p>";
...
echo "<br>";
echo "<a href=\"Protein_advanced_barchart_options_B73v5.php?name=$mygene&info=$all_info\">Advanced Options</a> <-- Allows you to chose which datasets to display.<br>";
...
echo "<a href=\"Rna_Protein_bar_chart_B73v5.php?name=$mygene&info=$all_info&gene=$gene\">Regenerate this particular analysis</a> <-- copy this link to share this result.<br>";
...
echo "<a href=\"Rna_Protein_bar_chart_B73v5.php?name=$mygene&info=$all_info&protein=$protein\">Regenerate this particular analysis</a> <-- copy this link to share this result.<br>";
}
?>
<br>
</div>
