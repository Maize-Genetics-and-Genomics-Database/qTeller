...
<h2><font color="green">B73 v5 Visualize Expression or Abundance</font></h2>
...
<p><i><b><font color="red">NOTE</font></b>:</i><b> B73 v5 Visualize Expression or Abundance</b><i> accepts only v5 gene IDs (Zm00001eb), not classical or GRMZM IDs. To convert your GRMZM IDs to v5, go</i><b> <a href="https://www.maizegdb.org/gene_center/gene#translate">HERE</a>.</b></p>
<div id="subheaderContainer">
<p><h3><font color="white">Single-Gene Expression or Abundance</font></h3></p>
        </div>

<br>
<form action="Rna_Protein_bar_chart_B73v5.php" method="post">
<a href="qT_bc2.png"><img src="qT_bc2.png" class="image1" width=500 /></a><br>
<br>
<div id="tool2Container">
	<br>
<b><font color="green">Gene Name: <input id = "geneName" type="text" name='name' /> </font></b>ZM*, Maize_refgen5<br>
<p>Try entering the id for glossy1 <i id='gene4' onclick="copyToClipboard('gene4','geneName')" style="cursor: pointer;color:blue;">Zm00001eb000020</i></p>
<p>To select only specific datasets, go to <a href="Protein_advanced_barchart_options_B73v5.php">Advanced options</a></p>
...
<form action="Rna_Protein_scatter_plot_B73v5.php" method="post">
...
<br>
<p>Try comparing the expression or abundance of these two genes <i id='gene5' onclick="copyToClipboard('gene5','geneName1')" style="cursor: pointer;color:blue;">Zm00001eb065560</i> and <i id='gene6' onclick="copyToClipboard('gene6','geneName2')" style="cursor: pointer;color:blue;">Zm00001eb065570</i><p>
<p>To select only specific datasets, go to <a href="Protein_advanced_scatterplot_options_B73v5.php">Advanced options</a></p>
<input type="submit" style="font-face: 'Comic Sans MS'; font-size: larger; color: white; background-color: #cc0000; border: 3pt ridge lightgrey" value=" Submit for mRNA Abundance! " name = "gene">
<input type="submit" style="font-face: 'Comic Sans MS'; font-size: larger; color: white; background-color: #cc0000; border: 3pt ridge lightgrey" value=" Submit for Protein Abundance! " name = "protein">
<br>
<br>
...
<form action="ProteinvsGene_chart_B73v5.php" method="post">
<a href="ProteinvsGene.png"><img src="ProteinvsGene.png" class="image1" width=500 /></a><br>
<br>
<div id="tool2Container">
	<br>
<b><font color="green">Gene Name: <input id = 'geneName7' type="text" name='name' /> </font></b>ZM*, Maize_refgen5<br>
<p>Try entering the id for glossy1 <i id='gene7' onclick="copyToClipboard('gene7','geneName7')" style="cursor: pointer;color:blue;">Zm00001eb065560</i></p>
<p>To select only specific datasets, go to <a href="advanced_GenevsProtein_options_B73v5.php">Advanced options</a></p>
...
<form action="Mutli_ProteinvsGene_chart_B73v5.php" method="post">
