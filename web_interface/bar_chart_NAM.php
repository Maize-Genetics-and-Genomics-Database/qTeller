...
if($all_info != 'all'){
echo exec("python image_handling/make_bar_chart_NAM.py --gene $mygene --exps \"$all_info\"");
}else {
echo exec("python image_handling/make_bar_chart_NAM.py --gene $mygene");
}
#echo "<p>$mygene</p>";
#echo "<p>$all_info</p>";
...
$NAM = "NAM";
require("./tmp/$NAM-$mygene-$expression-map.html");
echo "<br>";
echo "<a href=\"advanced_barchart_options_NAM.php?name=$mygene&info=$all_info\">Advanced Options</a> <-- Allows you to chose which datasets to display.<br>";
echo "Download this image as <a href=\"tmp/$NAM-$mygene-$expression.png\">a high resolution PNG</a> or <a href=\"tmp/$NAM-$mygene-$expression.svg\">a SVG</a> (best option editing in Inkscape/Illustrator)<br>";
echo "<a href=\"bar_chart_NAM.php?name=$mygene&info=$all_info\">Regenerate this particular analysis</a> <-- copy this link to share this result.<br>";
?>
<br>
</div>
</body>
