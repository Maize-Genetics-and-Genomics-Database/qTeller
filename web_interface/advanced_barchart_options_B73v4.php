...
class MyDB extends SQLite3
{
	...
	{
		$this->open('/var/www/html/qTeller/web_interface/qt4db');
	}
}
$db = new myDB();
...
<h2><font color="green">Single-Gene Expression Options</font></h2>
...
<br>
<form action="bar_chart_B73v4.php" method="post">
<b><font color="green">Gene Name: <input id = "geneName" type="text" name='name' <?php if ($have_data) {echo "value=\"$mygene\"";} ?> /></font></b><br>
<p>Try entering the id for <i>lg1</i> <i id='gene4' onclick="copyToClipboard('gene4','geneName')">Zm00001d000002</i></p>
