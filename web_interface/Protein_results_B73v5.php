...
if (isset($_POST["gene"])) {
$mycommand = "python interval_handling/make_spreadsheet_gene_B73v5.py --chr $mychr --start $mystart --stop $mystop";
} else if(isset($_POST["protein"])){
$mycommand = "python interval_handling/make_spreadsheet_B73v5_Pro.py --chr $mychr --start $mystart --stop $mystop";
