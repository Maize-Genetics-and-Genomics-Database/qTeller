...
if ($all_info != 'all'){
echo exec("python image_handling/make_bar_chart_B73v4.py --gene $mygene --exps \"$all_info\"");
}else {
echo exec("python image_handling/make_bar_chart_B73v4.py --gene $mygene");
}
#echo "<p>$mygene</p>";
#echo "<p>$all_info</p>";
...
echo "<br>";
echo "<a href=\"advanced_barchart_options_B73v4.php?name=$mygene&info=$all_info\">Advanced Options</a> <-- Allows you to chose which datasets to display.<br>";
...
echo "<a href=\"bar_chart_B73v4.php?name=$mygene&info=$all_info\">Regenerate this particular analysis</a> <-- copy this link to share this result.<br>";
?>
<br>
</div>
</body>
