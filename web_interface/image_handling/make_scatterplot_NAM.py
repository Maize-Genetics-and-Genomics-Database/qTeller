...
fh = open(('./tmp/%s-%s-%s-%s-map.html' % (NAM,mygene1, mygene2,expression)), 'w')
if (bool(myexp1) == True and bool(myexp2) == True):
    ...
    fig.savefig(('./tmp/%s-%s-%s-%s.svg' % (NAM,mygene1, mygene2,expression)), dpi=300)
    fig.savefig(('./tmp/%s-%s-%s-%s.png' % (NAM,mygene1, mygene2,expression)), dpi=300)
    fig2.savefig(('./tmp/%s-%s-%s-%s-front.png' % (NAM,mygene1, mygene2,expression)), dpi=80)
    # changed here
    ...
    fh.write(
        ...
        NAM,mygene1, mygene2,expression,NAM, mygene1, mygene2,expression, image_width, image_height))
